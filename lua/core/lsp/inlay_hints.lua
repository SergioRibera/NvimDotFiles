...
local inlay_hints_ns = vim.api.nvim_create_namespace("lsp_ext.inlay_hints")

inlay_hints.request = function(bufnr)
    vim.lsp.buf_request(bufnr or 0, "rust-analyzer/inlayHints", inlay_hints.get_params(), inlay_hints.get_callback())
...
inlay_hints.get_callback = function()
    local highlight = opts.highlight
    local prefix = opts.prefix
    local aligned = opts.aligned
